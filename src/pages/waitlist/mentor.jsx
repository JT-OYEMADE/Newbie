...
const Mentor = () => {
  ...
  const [formValues, setFormValues] = useState({
    ...
    Email: '',
    Expertise: '',
    Experience: 2, // Default value for years of experience
    Job: '',
    Company_Name: '',
  });
  ...
  async function onSubmit(e) {
    ...
    const googleSheetsURL = 'https://script.google.com/macros/s/AKfycbzuy7BEX38-bcO1d--51i52dywSca-l0FRSpXIJxjAyucraeaUIwpYK3J6ezNTsaDgE/exec';
  ...
  return (
    <div className="wait-container">
      <div className="wait-form">
        ...
        <p className="wait-p">
          Ready to seize opportunities? Join our exclusive waiting list today and fast-track your career.
        </p>
        <p className="wait-text">Choose Path</p>
        <div className="wait-tab">
          <Link to="/waitlist" className={generateTabClassName('first')} onClick={() => handleClick('first')}>
            <span>
